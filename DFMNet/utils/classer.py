...
def func(img, pic):
    ...
    if dark_prop >= 0.60:  # 人为设置的超参数:表示若偏暗像素所占比例超过0.78,则这张图被认为整体环境黑暗的图片

        cv2.imwrite("/home/hlj/YYB/RGB-T/RGBTCrowdCounting/BL+IADM for RGBT Crowd Counting/black/" + pic, img);  # 把被认为黑暗的图片保存
    else:
...
# 创建用于存放黑暗图片的目录
def createDarkDir():
    DarkDirPath = "/home/hlj/YYB/RGB-T/RGBTCrowdCounting/BL+IADM for RGBT Crowd Counting/black/";
...
if __name__ == '__main__':
    pics_path = "/home/hlj/YYB/RGBT-datasetes/highblacktest";  # 获取所给图片目录
    createDarkDir();
