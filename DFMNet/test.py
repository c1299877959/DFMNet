...
parser.add_argument('--save-dir', default='/home/hlj/YYB/RGB-T/RGBTCrowdCounting/BL+IADM for RGBT Crowd Counting',
                        help='model directory')
parser.add_argument('--model', default='/home/hlj/YYB/RGB-T/RGBTCrowdCounting/BL+IADM for RGBT Crowd Counting/exp1/0719-225633  13.00/best_model_3.pth'
                    , help='model name')
