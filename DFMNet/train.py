...
from utils.regression_trainer_original import RegTrainer
import argparse
import os
import torch
args = None
...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='/home/hlj/CYJ/ShanghaiTechRGBD',
                        help='training data directory')
    parser.add_argument('--save-dir', default='/home/hlj/YYB/RGB-T/RGBTCrowdCounting/BL+IADM for RGBT Crowd Counting/exp2',
